...
class ip2country {
	...
	public $mysql_host=CONF_DATABASE_HOST;
	public $db_name= CONF_DATABASE_NAME;
	public $db_user = CONF_DATABASE_USERNAME;
	public $db_pass = CONF_DATABASE_PASSWORD;
	public $table_name = 'an_ip2c';
