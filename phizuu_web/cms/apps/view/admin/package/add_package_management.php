...
<form id="addPackage" name="addPackage" method="get" onSubmit="showHint(this)">
	  ...
	  <div id="addMusicBttn2">
	    <div id="formRow">
		  ...
		  <div id="formSinFeild2">
		    <input  type="text" class="textFeildBoarder" style="width:227px; height:21px;" name="package" id="package" /><?php if(isset($_REQUEST['msg_error'])){echo $msg_error;}?>
		  </div>
		</div>
		<div id="formRow">
		  <div class="tahoma_12_blue" id="formName2">Video Limit</div>
		  <div id="formSinFeild2">
		    <input type="text" class="textFeildBoarder" style="width:227px; height:21px;" name="v_limit" id="v_limit"/>
		  </div>
		</div>
		<div id="formRow">
		  <div class="tahoma_12_blue" id="formName2">Music Limit</div>
		  <div id="formSinFeild2">
		    <input type="text" class="textFeildBoarder" style="width:227px; height:21px;"  name="m_limit" id="m_limit"/>
		  </div>
		</div>
        <div id="formRow">
		  <div class="tahoma_12_blue" id="formName2">Music Storage Limit (MB)</div>
		  <div id="formSinFeild2">
		    <input type="text" class="textFeildBoarder" style="width:227px; height:21px;" name="m_limit_storage" id="m_limit_storage"/>
		  </div>
		</div>
		<div id="formRow">
		  <div class="tahoma_12_blue" id="formName2">Photo Limit</div>
		  <div id="formSinFeild2">
		    <input type="text" class="textFeildBoarder" style="width:227px; height:21px;" name="p_limit" id="p_limit"/>
		  </div>
		</div>
