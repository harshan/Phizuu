            ...
            <div id="middleDiv2">
                ...
                <div id="body">
                    <div id="lightBlueHeader2">
                        ...
                        <div class="tahoma_14_white" id="newsHeader">Links Lists Section</div>
                    ...
                    <div id="addTourButton">
                        <img style="cursor: pointer " src="../../../images/addNewLinks.png" width="144" height="33" onclick="showAddView();" />
                    </div>
                    <p style="font-size: 6px;">&nbsp;</p>
                        ...
                        <form id="form" name="form" method="post" style="display: none;" onsubmit="javascritp: return formSubmit();">
                            ...
                            <div id="addMusicBttn2">
                                ...
                                <div id="formRow">
                                    ...
                                    <input type="text" class="textFeildBoarder" name="title" id="title" style="width: 298px;padding-left: 1px;height: 15px; " />
                                </div>
                                <div id="formRow">
            ...
            function MM_preloadImages() { //v3.0
                ...
                $(document).ready(function() {
                    ...
                    $('#linkSortable').bind('sortupdate', function(event, ui) {
                        ...
                        $.post('LinksController.php?action=order&'+order, function(data) {
                ...
                function formSubmit() {
                    ...
                    $.post("LinksController.php?action=add_new", { "title": $("#title").val(), "link": $("#link").val() },
                    function(data){
                        if(data.status == 'ok') {
                ...
                function deleteItem(id) {
                    ...
                    $.post("LinksController.php?action=delete_link", { 'id': id },
                    function(data){
                        if (data!='ok') {
