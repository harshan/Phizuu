...
foreach ($linksArr as $link) {
   $row = "<li id='id_{$link['id']}'>
              ...
              <div class='rowDivs tahoma_12_blue' style='width: 300px'>
                <div id='1_{$link['id']}' class='edit1'>{$link['title']}</div>
              </div>
              <div class='rowDivs tahoma_12_blue' style='width: 552px'>
                <div id='2_{$link['id']}' class='edit'>{$link['uri']}</div>
             </div>
                  <div class='ttip' style='float:left'>
             <div class='rowDivs action tahoma_12_blue' style='width: 31px'  id='delete_".$link['id']."'>
