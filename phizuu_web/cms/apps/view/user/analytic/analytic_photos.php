...
<input type="hidden" value="image" id="module"/>
<div id="analytic_body">
    <div>
        <div id="analytic_header">REPORT FOR PHOTOS MODULE VISITS</div>
        <div class="menu2">
        ...
        <div>
            <div style="50px">&nbsp;</div>
            <div id="analytic_header">REPORT FOR PHOTOS MODULE </div>
            <div class="menu3">
                <a href="#1" id="week">LAST 7 DAYS</a>
                <a href="#2" id="month">MONTH </a>
                <a href="#3" id="year">YEAR</a>
        ...
        <div style="clear: both;margin-top: 0px">
            <div id="analytic_header">LIST OF PHOTOS</div>  
            <div>
                <div id="analytic_pic_col">PICTURE</div>
                <div id="analytic_title_col">NAME</div>
