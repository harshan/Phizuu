...
<input type="hidden" value="links" id="module"/>
<div id="analytic_body">
    <div>
        <div id="analytic_header">REPORT FOR LINKS MODULE VISITS</div>
        <div class="menu2">
        ...
        <div>
            <div style="50px">&nbsp;</div>
            <div id="analytic_header">REPORT FOR LINKS MODULE </div>
            <div class="menu3">
                <a href="#1" id="week">LAST 7 DAYS</a>
                <a href="#2" id="month">MONTH </a>
                <a href="#3" id="year">YEAR</a>
        ...
        <?php
        $ch = curl_init(app_key_values::$API_URL . "analytic/" . $_SESSION['app_id'] . "/links/getall");
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        $linksArray = curl_exec($ch);
        $linksArray = json_decode($linksArray);
        ?>
        <div style="50px">&nbsp;</div>
        <div style="clear: both;margin-top: 0px">
            <div id="analytic_header">LIST OF LINKS</div>  
            <div>
                <div id="analytic_name_col">LINK</div>
