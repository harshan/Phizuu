...
<input type="hidden" value="news" id="module"/>
<div id="analytic_body">

    <div>
        <div id="analytic_header">REPORT FOR NEWS MODULE VISITS</div>
        <div class="menu2">
        ...
        <div>
            <div style="50px">&nbsp;</div>
            <div id="analytic_header">REPORT FOR NEWS MODULE </div>
            <div class="menu3">
                <a href="#1" id="week">LAST 7 DAYS</a>
                <a href="#2" id="month">MONTH </a>
                <a href="#3" id="year">YEAR</a>
        ...
        <div style="clear: both;margin-top: 0px">
            <div id="analytic_header">LIST OF NEWS</div>  
            <div>
