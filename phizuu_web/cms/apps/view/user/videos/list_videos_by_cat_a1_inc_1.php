...
$numrows =sizeof($playlists);

$pagename="list_videos_by_cat_a1.php?id=$id";
...
if(empty($video_det->video_id)){
	...
	$response .='
	<div id="vidAddBut">
	<img src="../../../images/btn_add.png" alt="This video is already added to the list!" width="83" height="25" border="0" onclick="javascript:alert(\'This video is already added to the list!\')"/></div>';
	}
