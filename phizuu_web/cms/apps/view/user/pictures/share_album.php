...
<div id="mainWideDiv">
  <div id="middleDiv2">
      ...
      <div class="rowBox tahoma_12_blue" style="padding: 5px">
          Following pictures of the album will be shared with the name '<?php echo $albumForHere[0]['album_name']; ?>' on your FaceBook Profile (<?php echo $me['name'] ?>). If you need  to <fb:login-button autologoutlink="true" size="large"></fb:login-button>     click here
      </div>
      <?php } else { ?>

      <div class="rowBox tahoma_12_blue" style="padding: 5px">
          Please login to FaceBook to share the album: <fb:login-button scope="photo_upload"></fb:login-button>
      </div>
      <?php } ?>
      <div class="rowBox tahoma_12_blue" style="padding: 5px">
      ...
      <div class="rowBox tahoma_12_blue" style="padding: 5px" id="progressDiv">
          <?php if($loggedIn) { ?>
          <img src="../../../images/share_on_fb.png" style="cursor:pointer" onclick="javascript:createAlbum();"/>
          <?php } ?>
      </div>
