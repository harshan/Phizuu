                   ...
                   $itemExist = FALSE;
                    ...
                    <div class="icons">
                        <?php if (!isset($flickrList)) { ?>
                            <div class="iconLeft clickable" onclick="javascript: delete_confirm(<?php echo $pic->id; ?>);" id="delete1_<?php echo $pic->id; ?>"></div>
                        <?php } else { ?>
                            <div class="iconLeftNone clickable" onclick="javascript: delete_confirm(<?php echo $pic->id; ?>);" id="delete1_<?php echo $pic->id; ?>"></div>
                        <?php } ?>
                        ...
                        <?php if (!isset($flickrList)) { ?>
                            <div class="iconRight clickable" onclick="javascript: moveItem(this);" id="move_<?php echo $pic->id; ?>"></div>
                        <?php } else { ?>
