...
function uploadProgress(file, bytesLoaded, bytesTotal) {
	try {
		var percent = Math.ceil((bytesLoaded / bytesTotal) * 100);
                ...
                var progress = new FileProgress(file, this.customSettings.progressTarget);
                if (percent==100) {
                    progress.setStatus("Please wait 2-3 minutes until the file transferred to the Storage server..");
                } else {
                    progress.setStatus("Uploading..");
                }
	...
	try {         
		...
		progress.toggleCancel(false);
                ...
                if (response.error == true) {
                    ...
                    $("#errorLogList").append("<li>Error in '" + file.name + "': "+response.error_message+'</li>');
                    progress.setStatus("Error! " + response.error_message);
                } else {
                    $(response.html).appendTo('#list_1').hide().fadeIn(300);
