...
(function($){
		...
		var g = {
			...
			getCellDim: function (obj) // get cell prop for editable event
			{
				...
				return {ht:ht,wt:wt,top:top,left:left,pdl:pdl, pdt:pdt, pht:pht, pwt: pwt};
                        ...
                        showBusy: function (msg) // get cell prop for editable event
			{
                            $('.pPageStat',this.pDiv).html(msg);
                        ...
                        hideBusy: function () // get cell prop for editable event
			{
                            $('.pReload',this.pDiv).removeClass('loading');
                            if (p.hideOnSubmit) $(g.block).remove();//$(t).show();
			},
	...
	$.fn.noSelect = function(p) { //no select plugin by me :-)
        ...
        $.fn.showBusy = function(message) { // function to add data to grid
            return this.each( function() {
                if (this.grid) this.grid.showBusy(message);;
            });
        };

        $.fn.hideBusy = function() { // function to add data to grid
            return this.each( function() {
                if (this.grid) this.grid.hideBusy();
            });
        };
