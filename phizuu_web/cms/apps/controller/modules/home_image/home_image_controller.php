...
if($action == 'delete_image'){
    ...
    $imagePathThumb = $_POST['imagePathThumb'];
    $homeImageModel = new home_image_model();
    $result = $homeImageModel->deleteHomeImage($id);
...
if($action == 'set_default'){
    ...
    $homeImageModel = new home_image_model();
    $homeImageModel->ReserDefauldImage($_SESSION['user_id']);
...
if($action == 'get_default_image'){
    $homeImageModel = new home_image_model();
    $result = $homeImageModel->GetDetaultImage($_SESSION['user_id']);
    echo $result[0]->id;
...
if($action == 'noOfRecoeds'){
    $homeImageModel = new home_image_model();
    $result = $homeImageModel->GetNoRecoeds($_SESSION['user_id']);
    echo $result;

}
if($action =='checkDetaultImage'){
    $homeImageModel = new home_image_model();
    $result = $homeImageModel->CheckDefaultImage($_SESSION['user_id']);
    echo $result;
}
