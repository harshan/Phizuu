...
switch($Submit){
	case"delete":
		$sql= "DELETE FROM ".$tbl_payment_information." WHERE autoid=".tosql($autoid,"Number");
...
function Delete(autoid)
{
	...
	if (userreq==true)
	{
		window.location='payments.php?Submit=delete&autoid='+autoid;
	}
}
</script>
</head>
...
<table width="1000" border="0" align="center">
  ...
  <tr bgcolor="#dbd9d9">
    ...
    <td width="97" valign="middle" class="Normal"><strong>&nbsp;&nbsp;&nbsp;Order Number</strong></td>
    ...
    <td width="139" align="center" valign="middle" class="Normal"><strong>Package</strong></td>
    <td width="144" align="center" valign="middle" class="Normal"><strong>Date Purchased</strong></td>
    <td width="197" valign="middle">&nbsp;</td>
  </tr>
  <?php
	
	$sql = "select * from ".$tbl_payment_information." order by autoid desc limit $eu, $limit";
	$query2 = "select fname from ".$tbl_payment_information." where status='true'";
  ...
  <tr bgcolor="#ececec" onMouseOver="this.bgColor='#dbd9d9'" onMouseOut="this.bgColor='#ececec'" onClick="">
    <td valign="middle" class="Normal" style="cursor:pointer" align="center"><?  	
			echo("[".$i."]");
			?></td>
    <td valign="middle" class="Normal" style="cursor:pointer">&nbsp;&nbsp;&nbsp;
      <?php echo getOrderNo($autoid) ?></td>
    ...
    <td align="center" valign="middle" class="Normal"><?php echo $package." ( $".$price." )" ?></td>
    <td align="center" valign="middle" class="Normal"><?php echo $date ?></td>
    <td align="center" valign="middle" class="Normal"><a href="more_details.php?id=<?php echo $autoid ?>" class="SubHead">More Details</a>&nbsp;&nbsp;<a href="#" class="SubHead" onClick="javascript:Delete('<?php echo $autoid?>')">Delete</a></td>
  </tr>
  <?php
	 $i++;
	  }
