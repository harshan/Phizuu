	...
	************************************************************************************************************/
	...
	function initGalleryScript()
	{
		...
		document.getElementById('arrow_up_image').onmousedown = initSlide;
		document.getElementById('arrow_up_image').onmouseup = stopSlide;
		
		document.getElementById('arrow_down_image').onmousedown = initSlide;
		document.getElementById('arrow_down_image').onmouseup = stopSlide;
