      ...
      <tr>
        <td align="center" valign="top"><div id="naviBig">
            ...
            <div id="naviBigPrizing">
				...
				<div id="signUpBody">
			  <div class="signUpHead1">
               <?php 
unset($_SESSION['upgrade']);			   

if($_SESSION['payment_error']=='yes') {
    echo "Upgrade Failed!!";
} else if($_SESSION['payment_error']=='no') {
...
if($_SESSION['payment_error']=='yes') {
	...
	echo "<b>Your payment has not been approved, but you can still continue with a free application or upgrade later.</b><br/><br/>";
} else if($_SESSION['payment_error']=='no') {
	echo "<b>Upgrade successful!</b>";
...
?>
               <br/>
Click <a href="cms/apps/controller/modules/app_wizard/AppWizardControllerNew.php">here</a> to go back to the application wizard.
