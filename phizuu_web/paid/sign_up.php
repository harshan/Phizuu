<?php
if(!isset ($_POST["package_id"]) && ($_POST["package_id"]>6 || $_POST["package_id"]<0)){
...
if(isset($_SESSION['upgrade'])) {
    ...
    echo "Sorry! No upgrade option is supported with your package!";
    exit;
}
...
if (isset($_POST['action'])) {
    ...
    if ($err_msg=='') {
        ...
        $_SESSION['sign_up_username'] = $username;
        $_SESSION['sign_up_email'] = $email;
        $_SESSION['sign_up_password'] = $password;
        $_SESSION['sign_up_package_id'] = $package_id;
        $_SESSION['sign_up_package_name'] = $package;
        $_SESSION['sign_up_package_price'] = $price;
        $_SESSION['sign_up_package_recurrent_price'] = $recurrentPrice;
