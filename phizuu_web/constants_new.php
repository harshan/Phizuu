...
define('API_USERNAME_LIVE', 'ranil_api1.phizuu.com'); //Live
define('API_USERNAME_SANDBOX', 'idhanu_api1.gmail.com'); //Sandbox
/**
...
define('API_PASSWORD_LIVE', 'NKY4TSL4X352W2CM'); //Live
define('API_PASSWORD_SANDBOX', 'XM3GEYRTV32BBFD7'); //Sandbox

/**
# API_Signature:The Signature associated with the API user. which is generated by paypal.
*/

define('API_SIGNATURE_LIVE', 'AFcWxV21C7fd0v3bYYYRCpSSRl31A4Z939FSXMS-JyxmXb6Ddctbiv5W'); //Live
define('API_SIGNATURE_SANDBOX', 'AbJ3HJzAO8QtS1s7ymKPSygReXnSA-c3I1S6.1P8NkbtJcsXWtbyDZZc');//Sandbox
/**
# Endpoint: this is the server URL which you have to connect for submitting your API request.
*/

define('API_ENDPOINT_LIVE', 'https://api-3t.paypal.com/nvp'); //Live
